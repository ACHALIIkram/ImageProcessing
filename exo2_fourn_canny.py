# -*- coding: utf-8 -*-
"""
Created on Fri Dec  6 20:29:41 2024
...
# Contours externes avec Canny
edges = cv2.Canny(blurred, 100, 200)  
contours = (edges > 0).astype(int)

# Paramètres de discrétisation
rmin, rmax, dr = 1, 100, 1
cmin, cmax, dc = 1, 100, 1
rad_min, rad_max, drad = 5, 50, 1  
...
maxima = (acc == local_max) & (acc > 0.6 * acc.max())  # Seuil ajusté
